...
//    while(Read_counter<=2){       //check data availability
//      Read_counter++;
//      if(Serial.available()){
//        byteRead[Read_counter] = Serial.read();           
//      }  
//    }
//    REF_FREQ= (byteRead[0]-48)*100+(byteRead[1]-48)*10+(byteRead[2]-48);
//
//    counter_max= 5000;//(1/REF_FREQ*(SINE_TABLE_MAX+1)-ADCLOOP_EXEC_TIME)/LOOP_EXEC_TIME;      //counter max is calculated by reference_frequency
