...
void main()
{
    ...
    scanf_s("%d",&users_values[0]);
	printf("Please enter amplitude:");
    scanf_s("%d",&users_values[1]);
	printf("Please enter phase:");
    scanf_s("%d",&users_values[2]);
	printf("Please enter direction:");
    scanf_s("%d",&users_values[3]);
