...
#include "sim_Motor_2kW_closedloop_v9_delay_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[39] = { "REF_AMP", "DEAD_TIME",
  ...
  "feedback_a", "feedback_b", "harm_a", "harm_b", "ctrl_sig", "ctrl_stored_out",
  "Timer_prev_out", "counter_out", "down_flag_out", "error", "test" };

/* Function Declarations */
static void initialize_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_closedloop_v9_delay
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance);
...
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_floor(SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_sim_Motor_2kW_closedloop_v9_delay, const char_T
   *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_floor(SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct
  ...
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v9_delay = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal =
    chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v9_delay;
   ...
   mxArray *c2_st)
{
  ...
  *c2_test = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v9_delay =
    ...
    "is_active_c2_sim_Motor_2kW_closedloop_v9_delay");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v9_delay(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_ctrl_stored_out)[3];
  real_T (*c2_ctrl_sig)[6];
  c2_harm_b = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c2_harm_a = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c2_test = (real_T *)ssGetOutputPortSignal(chartInstance->S, 7);
  c2_error = (real_T *)ssGetOutputPortSignal(chartInstance->S, 6);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_harm_a, 16U);
  _SFD_DATA_RANGE_CHECK(*c2_harm_b, 17U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_closedloop_v9_delay(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_sim_Motor_2kW_closedloop_v9_delayMachineNumber_,
  ...
  (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance)
{
  ...
  c2_b_harm_b = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c2_b_harm_a = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  ...
  c2_i_hoistedGlobal = *c2_b_harm_a;
  c2_j_hoistedGlobal = *c2_b_harm_b;
  ...
  c2_harm_a = c2_i_hoistedGlobal;
  c2_harm_b = c2_j_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml(&c2_harm_a, 30U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_harm_b, 31U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_sig, 32U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_stored_out, 33U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Timer_prev_out, 34U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_counter_out, 35U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_down_flag_out, 36U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_error, 37U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_test, 38U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_sim_Motor_2kW_closedloop_v9_delay_get_eml_resolved_functions_info(void)
{
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_closedloop_v9_delay), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_closedloop_v9_delay);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_closedloop_v9_delay_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1795634660U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3446730984U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2222093137U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3998924843U);
}

mxArray *sf_c2_sim_Motor_2kW_closedloop_v9_delay_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("NT71xzZ5CQ2By7l0u9xUqF");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v9_delay
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[19],T\"Timer_prev_out\",},{M[1],M[25],T\"counter_out\",},{M[1],M[5],T\"ctrl_sig\",},{M[1],M[23],T\"ctrl_stored_out\",},{M[1],M[36],T\"down_flag_out\",},{M[1],M[34],T\"error\",},{M[1],M[37],T\"test\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_closedloop_v9_delay\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_closedloop_v9_delay_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(16,1,1,0,"harm_a");
          _SFD_SET_DATA_PROPS(17,1,1,0,"harm_b");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,7926);
        _SFD_CV_INIT_EML_IF(0,1,0,3809,3835,4752,5703);
        _SFD_CV_INIT_EML_IF(0,1,1,4752,4770,5610,5703);
        _SFD_CV_INIT_EML_IF(0,1,2,5712,5742,5890,6192);
        _SFD_CV_INIT_EML_IF(0,1,3,5890,5930,6107,6192);
        _SFD_CV_INIT_EML_IF(0,1,4,6208,6238,6338,6487);
        _SFD_CV_INIT_EML_IF(0,1,5,6338,6378,6429,6487);
        _SFD_CV_INIT_EML_IF(0,1,6,6503,6533,6629,6778);
        _SFD_CV_INIT_EML_IF(0,1,7,6629,6669,6720,6778);
        _SFD_CV_INIT_EML_IF(0,1,8,7272,7292,7399,7445);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(16U, c2_harm_a);
          _SFD_SET_DATA_VALUE_PTR(17U, c2_harm_b);
        }
      }
    } else {
...
{
  return "nVpzjxW721ucyx0KYY4ZXC";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v9_delay(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v9_delay(void
  *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v9_delay(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v9_delay(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v9_delay();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v9_delay(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_closedloop_v9_delay
      ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_sim_Motor_2kW_closedloop_v9_delay_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_sim_Motor_2kW_closedloop_v9_delay
    ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_closedloop_v9_delay
      ((SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_sim_Motor_2kW_closedloop_v9_delay_optimization_info();
  ...
  ssSetChecksum0(S,(2181881973U));
  ssSetChecksum1(S,(1756451988U));
  ssSetChecksum2(S,(953286712U));
  ssSetChecksum3(S,(2247911179U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_closedloop_v9_delay(SimStruct *S)
{
  SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct *)malloc
    (sizeof(SFc2_sim_Motor_2kW_closedloop_v9_delayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_sim_Motor_2kW_closedloop_v9_delay;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v9_delay;
...
void c2_sim_Motor_2kW_closedloop_v9_delay_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_closedloop_v9_delay(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v9_delay(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v9_delay(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_closedloop_v9_delay_method_dispatcher.\n"
