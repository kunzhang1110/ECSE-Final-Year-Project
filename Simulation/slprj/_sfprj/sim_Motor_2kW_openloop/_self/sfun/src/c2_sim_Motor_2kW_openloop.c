...
static const char * c2_debug_family_names[25] = { "REF_AMP", "REF_FREQ",
  "AMP_MOD", "FREQ_MOD", "TRI_AMP", "TRI_FREQ", "TRI_PER", "ref_c", "tri_wav",
  "pwm_1", "pwm_3", "pwm_5", "pwm_2", "pwm_4", "pwm_6", "mag_fb", "nargin",
  "nargout", "ref_a", "ref_b", "t", "fb_phase_a", "fb_phase_b", "ctrl_sig",
  "error" };
  ...
  (SFc2_sim_Motor_2kW_openloopInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 17U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_ref_a, 18U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_ref_b, 19U, c2_sf_marshallOut);
  ...
  if (CV_EML_IF(0, 1, 1, c2_ref_b > c2_tri_wav)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 42);
    c2_pwm_3 = c2_REF_AMP;
  } else {
  ...
  if (CV_EML_IF(0, 1, 2, c2_ref_c > c2_tri_wav)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 46);
    c2_pwm_5 = c2_REF_AMP;
  } else {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(115170388U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(934382986U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2326610755U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(113603740U);
}
...
mxArray *sf_c2_sim_Motor_2kW_openloop_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ZVnQSGVjKEUNZh3W95X0GG");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,5411);
        _SFD_CV_INIT_EML_IF(0,1,0,3814,3837,3875,3928);
        _SFD_CV_INIT_EML_IF(0,1,1,3930,3953,4003,4058);
        _SFD_CV_INIT_EML_IF(0,1,2,4060,4083,4117,4171);
        _SFD_CV_INIT_EML_IF(0,1,3,4419,4435,4475,4528);
        _SFD_CV_INIT_EML_IF(0,1,4,4530,4546,4586,4639);
        _SFD_CV_INIT_EML_IF(0,1,5,4641,4657,4697,4750);
...
static void mdlSetWorkWidths_c2_sim_Motor_2kW_openloop(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3661594308U));
  ssSetChecksum1(S,(196580397U));
  ssSetChecksum2(S,(1999497618U));
  ssSetChecksum3(S,(3604288703U));
