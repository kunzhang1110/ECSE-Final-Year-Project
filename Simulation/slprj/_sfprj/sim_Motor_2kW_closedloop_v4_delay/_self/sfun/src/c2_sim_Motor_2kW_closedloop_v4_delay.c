...
#include "sim_Motor_2kW_closedloop_v4_delay_sfun.h"
#include "c2_sim_Motor_2kW_closedloop_v4_delay.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "sim_Motor_2kW_closedloop_v4_delay_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[34] = { "REF_AMP", "DEAD_TIME",
  ...
  "ref_a", "ref_b", "Timer", "Timer_prev", "phase_stored", "counter",
  "feedback_a", "feedback_b", "ctrl_sig", "phase_stored_out", "Timer_prev_out",
  "counter_out", "test" };

/* Function Declarations */
static void initialize_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_closedloop_v4_delay
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance);
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_sim_Motor_2kW_closedloop_v4_delay, const char_T
   *c2_identifier);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v4_delay = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance)
{
  ...
  c2_test = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
   ...
   mxArray *c2_st)
{
  ...
  *c2_counter_out = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
                        "phase_stored_out", c2_dv1);
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    (*c2_phase_stored_out)[c2_i3] = c2_dv1[c2_i3];
  }
  ...
  *c2_test = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v4_delay =
    ...
    "is_active_c2_sim_Motor_2kW_closedloop_v4_delay");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v4_delay(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance)
{
  ...
  for (c2_i5 = 0; c2_i5 < 3; c2_i5++) {
    _SFD_DATA_RANGE_CHECK((*c2_phase_stored_out)[c2_i5], 2U);
  }
  ...
  for (c2_i6 = 0; c2_i6 < 3; c2_i6++) {
    _SFD_DATA_RANGE_CHECK((*c2_phase_stored)[c2_i6], 6U);
  }
  ...
  _SFD_DATA_RANGE_CHECK(*c2_test, 12U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_closedloop_v4_delay(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_sim_Motor_2kW_closedloop_v4_delayMachineNumber_,
  ...
  (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance)
{
  ...
  c2_b_test = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  ...
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    c2_phase_stored[c2_i7] = (*c2_b_phase_stored)[c2_i7];
  }
  ...
  sf_debug_symbol_scope_add_eml(c2_phase_stored, 25U, c2_b_sf_marshallOut);
  ...
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_sig, 29U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_phase_stored_out, 30U,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_counter_out, 32U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_test, 33U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c2_counter == c2_Count_Max)) {
    ...
    for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
      c2_phase_stored_out[c2_i8] = c2_m_x[c2_i8];
    }
    ...
    for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
      c2_u[c2_i9] = c2_phase_stored_out[c2_i9];
    }
    ...
    for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
      c2_phase_stored_out[c2_i10] = c2_phase_stored[c2_i10];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 51);
  if (CV_EML_IF(0, 1, 1, c2_counter < c2_phase_stored[0])) {
    ...
    if (CV_EML_IF(0, 1, 2, c2_counter < c2_phase_stored[0] + c2_DEAD_TIME)) {
  ...
  if (CV_EML_IF(0, 1, 3, c2_counter < c2_phase_stored[1])) {
    ...
    if (CV_EML_IF(0, 1, 4, c2_counter < c2_phase_stored[1] + c2_DEAD_TIME)) {
  ...
  if (CV_EML_IF(0, 1, 5, c2_counter + 1.0 < c2_phase_stored[2])) {
    ...
    if (CV_EML_IF(0, 1, 6, c2_counter < c2_phase_stored[2] + c2_DEAD_TIME)) {
  ...
  for (c2_i11 = 0; c2_i11 < 6; c2_i11++) {
    c2_ctrl_sig[c2_i11] = c2_b_pwm_1[c2_i11];
  }
  ...
  for (c2_i12 = 0; c2_i12 < 6; c2_i12++) {
    (*c2_b_ctrl_sig)[c2_i12] = c2_ctrl_sig[c2_i12];
  }

  for (c2_i13 = 0; c2_i13 < 3; c2_i13++) {
    (*c2_b_phase_stored_out)[c2_i13] = c2_phase_stored_out[c2_i13];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *)
    chartInstanceVoid;
   ...
   mxArray *c2_phase_stored_out, const char_T *c2_identifier, real_T c2_y[3])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_phase_stored_out),
                        &c2_thisId, c2_y);
...
const mxArray
  *sf_c2_sim_Motor_2kW_closedloop_v4_delay_get_eml_resolved_functions_info(void)
{
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_closedloop_v4_delay), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_closedloop_v4_delay);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_closedloop_v4_delay_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1010570672U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3790552993U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3621189289U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2537748484U);
}

mxArray *sf_c2_sim_Motor_2kW_closedloop_v4_delay_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("j4DLNYCPg8cbX3Jcj8eI0G");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v4_delay
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[19],T\"Timer_prev_out\",},{M[1],M[25],T\"counter_out\",},{M[1],M[5],T\"ctrl_sig\",},{M[1],M[23],T\"phase_stored_out\",},{M[1],M[34],T\"test\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_closedloop_v4_delay\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_closedloop_v4_delay_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(12,2,0,1,"test");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,6935);
        _SFD_CV_INIT_EML_IF(0,1,0,4551,4577,4809,4935);
        _SFD_CV_INIT_EML_IF(0,1,1,4944,4975,5122,5424);
        _SFD_CV_INIT_EML_IF(0,1,2,5122,5163,5339,5424);
        _SFD_CV_INIT_EML_IF(0,1,3,5440,5471,5571,5721);
        _SFD_CV_INIT_EML_IF(0,1,4,5571,5612,5663,5721);
        _SFD_CV_INIT_EML_IF(0,1,5,5737,5770,5866,6016);
        _SFD_CV_INIT_EML_IF(0,1,6,5866,5907,5958,6016);
        _SFD_CV_INIT_EML_IF(0,1,7,6018,6043,-1,6395);
        _SFD_CV_INIT_EML_IF(0,1,8,6397,6432,-1,6609);

        {
          static int condStart[] = { 6405, 6423 };

          static int condEnd[] = { 6419, 6432 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,6405,6432,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(12U, c2_test);
        }
      }
    } else {
...
{
  return "15HtcLbRht6Ly39e3VpaeF";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v4_delay(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v4_delay(void
  *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v4_delay(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v4_delay(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v4_delay();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v4_delay(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_closedloop_v4_delay
      ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_sim_Motor_2kW_closedloop_v4_delay_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_sim_Motor_2kW_closedloop_v4_delay
    ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_closedloop_v4_delay
      ((SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_sim_Motor_2kW_closedloop_v4_delay_optimization_info();
  ...
  ssSetChecksum0(S,(2865403615U));
  ssSetChecksum1(S,(287114589U));
  ssSetChecksum2(S,(3825539243U));
  ssSetChecksum3(S,(683709111U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_closedloop_v4_delay(SimStruct *S)
{
  SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct *)malloc
    (sizeof(SFc2_sim_Motor_2kW_closedloop_v4_delayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_sim_Motor_2kW_closedloop_v4_delay;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v4_delay;
...
void c2_sim_Motor_2kW_closedloop_v4_delay_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_closedloop_v4_delay(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v4_delay(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v4_delay(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_closedloop_v4_delay_method_dispatcher.\n"
