...
#include "sim_Motor_2kW_closedloop_v5_delay_sfun.h"
#include "c2_sim_Motor_2kW_closedloop_v5_delay.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "sim_Motor_2kW_closedloop_v5_delay_sfun_debug_macros.h"
...
static void initialize_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_closedloop_v5_delay
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance, const
   mxArray *c2_error, const char_T *c2_identifier);
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_sim_Motor_2kW_closedloop_v5_delay, const char_T
   *c2_identifier);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v5_delay = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance)
{
  ...
  c2_error = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
   ...
   mxArray *c2_st)
{
  ...
  *c2_error = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v5_delay =
    ...
    "is_active_c2_sim_Motor_2kW_closedloop_v5_delay");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v5_delay(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c2_error, 12U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_closedloop_v5_delay(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_sim_Motor_2kW_closedloop_v5_delayMachineNumber_,
  ...
  (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance)
{
  ...
  c2_b_error = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_counter_out, 32U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_error, 33U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_sim_Motor_2kW_closedloop_v5_delay_get_eml_resolved_functions_info(void)
{
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_closedloop_v5_delay), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_closedloop_v5_delay);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_closedloop_v5_delay_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1326703704U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4249604718U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1685431144U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1695802768U);
}

mxArray *sf_c2_sim_Motor_2kW_closedloop_v5_delay_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("v6FWqvMxGY2Np5OmCqubqE");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v5_delay
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[19],T\"Timer_prev_out\",},{M[1],M[25],T\"counter_out\",},{M[1],M[5],T\"ctrl_sig\",},{M[1],M[23],T\"ctrl_stored_out\",},{M[1],M[34],T\"error\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_closedloop_v5_delay\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_closedloop_v5_delay_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,4537,4563,4794,4920);
        _SFD_CV_INIT_EML_IF(0,1,1,4929,4959,5107,5409);
        _SFD_CV_INIT_EML_IF(0,1,2,5107,5147,5324,5409);
        _SFD_CV_INIT_EML_IF(0,1,3,5425,5455,5555,5704);
        _SFD_CV_INIT_EML_IF(0,1,4,5555,5595,5646,5704);
        _SFD_CV_INIT_EML_IF(0,1,5,5720,5752,5848,5997);
        _SFD_CV_INIT_EML_IF(0,1,6,5848,5888,5939,5997);
        _SFD_CV_INIT_EML_IF(0,1,7,5999,6024,-1,6376);
...
{
  return "kDNCJEmcP1X9QDaqjBw9c";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v5_delay(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v5_delay(void
  *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v5_delay(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v5_delay(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v5_delay();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v5_delay(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_closedloop_v5_delay
      ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_sim_Motor_2kW_closedloop_v5_delay_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_sim_Motor_2kW_closedloop_v5_delay
    ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_closedloop_v5_delay
      ((SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_sim_Motor_2kW_closedloop_v5_delay_optimization_info();
  ...
  ssSetChecksum0(S,(2139122522U));
  ssSetChecksum1(S,(768003417U));
  ssSetChecksum2(S,(202658600U));
  ssSetChecksum3(S,(2842690746U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_closedloop_v5_delay(SimStruct *S)
{
  SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct *)malloc
    (sizeof(SFc2_sim_Motor_2kW_closedloop_v5_delayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_sim_Motor_2kW_closedloop_v5_delay;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v5_delay;
...
void c2_sim_Motor_2kW_closedloop_v5_delay_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_closedloop_v5_delay(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v5_delay(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v5_delay(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_closedloop_v5_delay_method_dispatcher.\n"
