...
#include "sim_Motor_2kW_openloop_v3_sfun.h"
#include "c2_sim_Motor_2kW_openloop_v3.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "sim_Motor_2kW_openloop_v3_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[22] = { "REF_AMP", "Timer_Ratio",
  "phase_c", "pwm_1", "pwm_2", "pwm_3", "pwm_4", "pwm_5", "pwm_6", "nargin",
  "nargout", "phase_a", "phase_b", "Timer1", "Timer2", "Timer_prev",
  "phase_stored", "counter", "ctrl_sig", "phase_stored_out", "Timer_prev_out",
  "counter_out" };

/* Function Declarations */
static void initialize_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_openloop_v3
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_counter_out, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_Timer_prev_out, const char_T *c2_identifier,
  real_T c2_y[2]);
static void c2_d_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_phase_stored_out, const char_T
  *c2_identifier, real_T c2_y[3]);
static void c2_f_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_ctrl_sig, const char_T *c2_identifier,
  real_T c2_y[6]);
static void c2_h_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
...
static uint8_T c2_j_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_sim_Motor_2kW_openloop_v3, const char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct
  *chartInstance);
  ...
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_v3 = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_v3;
   ...
   *c2_st)
{
  ...
  *c2_counter_out = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_v3 =
    c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
    "is_active_c2_sim_Motor_2kW_openloop_v3");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_openloop_v3(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_openloop_v3(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_sim_Motor_2kW_openloop_v3MachineNumber_, chartInstance->chartNumber,
  ...
  (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_push_eml(0U, 22U, 22U, c2_debug_family_names,
    c2_debug_family_var_map);
  sf_debug_symbol_scope_add_eml_importable(&c2_REF_AMP, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_Timer_Ratio, 1U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_phase_c, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_1, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_2, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_3, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_4, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_5, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_6, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_phase_a, 11U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_phase_b, 12U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_Timer1, 13U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_Timer2, 14U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c2_Timer_prev, 15U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c2_phase_stored, 16U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_counter, 17U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_sig, 18U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_phase_stored_out, 19U,
    c2_c_sf_marshallOut, c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_Timer_prev_out, 20U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_counter_out, 21U,
  ...
  if (CV_EML_COND(0, 1, 0, c2_Timer_prev[0] < 0.2)) {
    if (CV_EML_COND(0, 1, 1, c2_Timer1 > 0.8)) {
      ...
      for (c2_i13 = 0; c2_i13 < 3; c2_i13++) {
        c2_phase_stored_out[c2_i13] = c2_g_x[c2_i13];
      }

      for (c2_k = 0; c2_k < 3; c2_k++) {
        c2_b_k = 1.0 + (real_T)c2_k;
        c2_h_x = c2_phase_stored_out[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        ...
        c2_phase_stored_out[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", c2_b_k), 1, 3, 1, 0) - 1] = c2_i_x;
      }
      ...
      c2_d_y = NULL;
      sf_mex_assign(&c2_d_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 3),
                    FALSE);
  ...
  if (CV_EML_IF(0, 1, 2, c2_counter < c2_phase_stored[0] + 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 3, c2_counter < c2_phase_stored[1] + 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 4, c2_counter < c2_phase_stored[2] + 1.0)) {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_sim_Motor_2kW_openloop_v3_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_sim_Motor_2kW_openloop_v3, const char_T *c2_identifier)
{
  ...
  c2_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_openloop_v3), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_openloop_v3);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_openloop_v3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1019427550U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(198583543U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2738475415U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1704746088U);
}

mxArray *sf_c2_sim_Motor_2kW_openloop_v3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("f2qSFYi3B7PH64sFNazSbH");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_v3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[19],T\"Timer_prev_out\",},{M[1],M[25],T\"counter_out\",},{M[1],M[5],T\"ctrl_sig\",},{M[1],M[23],T\"phase_stored_out\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_openloop_v3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_openloop_v3_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_sim_Motor_2kW_openloop_v3MachineNumber_,
           2,
           1,
           1,
           11,
        ...
        _SFD_CV_INIT_EML(0,1,1,5,0,0,0,0,4,2);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,5287);
        _SFD_CV_INIT_EML_IF(0,1,0,3886,3925,4088,4145);
        _SFD_CV_INIT_EML_IF(0,1,1,4147,4186,-1,4361);
        _SFD_CV_INIT_EML_IF(0,1,2,4363,4396,4507,4565);
        _SFD_CV_INIT_EML_IF(0,1,3,4567,4600,4711,4769);
        _SFD_CV_INIT_EML_IF(0,1,4,4771,4804,4903,4961);

        {
          static int condStart[] = { 3894, 3915 };

          static int condEnd[] = { 3911, 3925 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,3894,3925,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4155, 4176 };

          static int condEnd[] = { 4172, 4186 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,4155,4186,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
{
  return "mm1Yu7a7ou7q6KBUHo45c";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_openloop_v3(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_openloop_v3(void *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_openloop_v3(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_openloop_v3(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_openloop_v3((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_sim_Motor_2kW_openloop_v3
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_v3();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_openloop_v3(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_sim_Motor_2kW_openloop_v3
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_openloop_v3(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_openloop_v3(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_openloop_v3(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_openloop_v3(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_openloop_v3
      ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_sim_Motor_2kW_openloop_v3_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_sim_Motor_2kW_openloop_v3
    ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_openloop_v3(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_openloop_v3
      ((SFc2_sim_Motor_2kW_openloop_v3InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_sim_Motor_2kW_openloop_v3_optimization_info();
  ...
  ssSetChecksum0(S,(2498479316U));
  ssSetChecksum1(S,(2156642623U));
  ssSetChecksum2(S,(2424976726U));
  ssSetChecksum3(S,(3235374041U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_openloop_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_openloop_v3(SimStruct *S)
{
  SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct *)malloc(sizeof
    (SFc2_sim_Motor_2kW_openloop_v3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_sim_Motor_2kW_openloop_v3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_sim_Motor_2kW_openloop_v3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_v3;
...
void c2_sim_Motor_2kW_openloop_v3_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_openloop_v3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_v3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_openloop_v3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_openloop_v3_method_dispatcher.\n"
