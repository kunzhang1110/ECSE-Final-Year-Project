...
static const char * c2_debug_family_names[24] = { "REF_AMP", "REC_FREQ",
  "REC_PER", "VON", "phase_c", "D", "pwm_1", "pwm_2", "pwm_3", "pwm_4", "pwm_5",
  "pwm_6", "nargin", "nargout", "phase_a", "phase_b", "t", "ton", "tstart",
  "init_flag", "ctrl_sig", "ton_out", "tstart_out", "init_flag_out" };
  ...
  (SFc2_sim_Motor_2kW_openloop_v2InstanceStruct *chartInstance)
{
  ...
  c2_ton_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c2_hoistedGlobal = *c2_init_flag_out;
  c2_b_u = c2_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_b_hoistedGlobal = *c2_ton_out;
   ...
   *c2_st)
{
  ...
  *c2_init_flag_out = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "init_flag_out");
  *c2_ton_out = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 2)), "ton_out");
  ...
  (SFc2_sim_Motor_2kW_openloop_v2InstanceStruct *chartInstance)
{
  ...
  c2_ton = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c2_ton_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_ton_out, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_ton, 5U);
  ...
  (SFc2_sim_Motor_2kW_openloop_v2InstanceStruct *chartInstance)
{
  ...
  c2_b_ton = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c2_b_ton_out = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c2_ton = c2_d_hoistedGlobal;
  c2_tstart = c2_e_hoistedGlobal;
  c2_init_flag = c2_f_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 24U, 24U, c2_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_phase_c, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_D, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_1, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_2, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_3, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_4, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_5, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_6, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargin, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 13U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_phase_a, 14U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_phase_b, 15U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t, 16U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_ton, 17U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_tstart, 18U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_init_flag, 19U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_sig, 20U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_ton_out, 21U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_tstart_out, 22U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_init_flag_out, 23U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c2_t < c2_REC_PER + c2_tstart)) {
    ...
    c2_a = c2_D;
    c2_ton = c2_a * 0.00066666666666666664;
    ...
    if (CV_EML_IF(0, 1, 2, c2_t <= c2_tstart + c2_ton)) {
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 43);
      c2_pwm_1 = c2_VON;
    } else {
  ...
  if (CV_EML_IF(0, 1, 3, c2_t > c2_tstart + c2_REC_PER)) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1388260066U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1290035645U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(76777560U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2194748510U);
}
...
mxArray *sf_c2_sim_Motor_2kW_openloop_v2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("v1uL5FQ11To6eiXfxep9WF");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_v2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ctrl_sig\",},{M[1],M[16],T\"init_flag_out\",},{M[1],M[11],T\"ton_out\",},{M[1],M[14],T\"tstart_out\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_openloop_v2\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(4,2,0,1,"ton_out");
          _SFD_SET_DATA_PROPS(5,1,1,0,"ton");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,7581);
        _SFD_CV_INIT_EML_IF(0,1,0,4441,4465,-1,4864);
        _SFD_CV_INIT_EML_IF(0,1,1,4660,4680,-1,4746);
        _SFD_CV_INIT_EML_IF(0,1,2,4755,4778,4831,4860);
        _SFD_CV_INIT_EML_IF(0,1,3,4908,4932,5338,5438);
        _SFD_CV_INIT_EML_IF(0,1,4,5338,5365,5413,5438);
        _SFD_CV_INIT_EML_IF(0,1,5,5578,5594,5630,5683);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, c2_ton_out);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_ton);
...
static void mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_v2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(43387166U));
  ssSetChecksum1(S,(3885370362U));
  ssSetChecksum2(S,(2943844591U));
  ssSetChecksum3(S,(1754560852U));
