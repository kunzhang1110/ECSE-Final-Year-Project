...
#include "sim_Motor_2kW_closedloop_v7_delay_sfun.h"
#include "c2_sim_Motor_2kW_closedloop_v7_delay.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "sim_Motor_2kW_closedloop_v7_delay_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[34] = { "REF_AMP", "DEAD_TIME",
  ...
  "ref_a", "ref_b", "Timer", "Timer_prev", "ctrl_stored", "counter",
  "feedback_a", "feedback_b", "pwm_out", "ctrl_stored_out", "Timer_prev_out",
  "counter_out", "ctrl_sig" };

/* Function Declarations */
static void initialize_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_closedloop_v7_delay
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance, const
   mxArray *c2_ctrl_sig, const char_T *c2_identifier);
...
static void c2_e_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance, const
   mxArray *c2_pwm_out, const char_T *c2_identifier, real_T c2_y[6]);
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_sim_Motor_2kW_closedloop_v7_delay, const char_T
   *c2_identifier);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v7_delay = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance)
{
  ...
  c2_ctrl_sig = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  ...
  c2_pwm_out = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  ...
  c2_c_hoistedGlobal = *c2_ctrl_sig;
  c2_c_u = c2_c_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 2, c2_d_y);
  for (c2_i0 = 0; c2_i0 < 3; c2_i0++) {
    c2_d_u[c2_i0] = (*c2_ctrl_stored_out)[c2_i0];
  }
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v7_delay;
   ...
   mxArray *c2_st)
{
  ...
  *c2_counter_out = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 1)), "counter_out");
  *c2_ctrl_sig = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 2)), "ctrl_sig");
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
                        "ctrl_stored_out", c2_dv0);
  for (c2_i2 = 0; c2_i2 < 3; c2_i2++) {
    (*c2_ctrl_stored_out)[c2_i2] = c2_dv0[c2_i2];
  }

  c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
                        "pwm_out", c2_dv1);
  for (c2_i3 = 0; c2_i3 < 6; c2_i3++) {
    (*c2_pwm_out)[c2_i3] = c2_dv1[c2_i3];
  }

  chartInstance->c2_is_active_c2_sim_Motor_2kW_closedloop_v7_delay =
    c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 5)),
    "is_active_c2_sim_Motor_2kW_closedloop_v7_delay");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_closedloop_v7_delay(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance)
{
  ...
  for (c2_i4 = 0; c2_i4 < 6; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_pwm_out)[c2_i4], 1U);
  }
  ...
  _SFD_DATA_RANGE_CHECK(*c2_ctrl_sig, 12U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_closedloop_v7_delay(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_sim_Motor_2kW_closedloop_v7_delayMachineNumber_,
  ...
  (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance)
{
  ...
  real_T *c2_b_ref_b;
  real_T *c2_b_ref_a;
  real_T (*c2_b_pwm_out)[6];
  real_T (*c2_b_ctrl_stored_out)[3];
  real_T (*c2_b_ctrl_stored)[3];
  c2_b_ctrl_sig = (real_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  ...
  c2_b_ctrl_stored_out = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
    2);
  c2_b_pwm_out = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  sf_debug_symbol_scope_push_eml(0U, 34U, 34U, c2_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c2_feedback_a, 27U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_feedback_b, 28U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_pwm_out, 29U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_ctrl_stored_out, 30U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Timer_prev_out, 31U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_counter_out, 32U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_ctrl_sig, 33U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_a = c2_feedback_a;
  c2_feedback_a_scaled = c2_a * 0.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 29);
  c2_b_a = c2_feedback_b;
  c2_feedback_b_scaled = c2_b_a * 0.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 30);
  c2_c_a = c2_feedback_c;
  c2_feedback_c_scaled = c2_c_a * 0.0;
  ...
  if (CV_EML_IF(0, 1, 0, c2_counter == c2_Count_Max)) {
    ...
    for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
      c2_ctrl_stored_out[c2_i8] = c2_m_x[c2_i8];
    }

    for (c2_k = 0; c2_k < 3; c2_k++) {
      c2_b_k = 1.0 + (real_T)c2_k;
      c2_n_x = c2_ctrl_stored_out[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    ...
    for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
      c2_u[c2_i9] = c2_ctrl_stored_out[c2_i9];
    }
    ...
    for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
      c2_ctrl_stored_out[c2_i10] = c2_ctrl_stored[c2_i10];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 51);
  if (CV_EML_IF(0, 1, 1, c2_counter < c2_ctrl_stored[0])) {
    ...
    if (CV_EML_IF(0, 1, 2, c2_counter < c2_ctrl_stored[0] + c2_DEAD_TIME)) {
  ...
  if (CV_EML_IF(0, 1, 3, c2_counter < c2_ctrl_stored[1])) {
    ...
    if (CV_EML_IF(0, 1, 4, c2_counter < c2_ctrl_stored[1] + c2_DEAD_TIME)) {
  ...
  if (CV_EML_IF(0, 1, 5, c2_counter + 1.0 < c2_ctrl_stored[2])) {
    ...
    if (CV_EML_IF(0, 1, 6, c2_counter < c2_ctrl_stored[2] + c2_DEAD_TIME)) {
  ...
  if (CV_EML_IF(0, 1, 7, c2_counter < c2_DEAD_TIME)) {
  ...
  for (c2_i11 = 0; c2_i11 < 6; c2_i11++) {
    c2_pwm_out[c2_i11] = c2_b_pwm_1[c2_i11];
  }
  ...
  c2_ctrl_sig = c2_ctrl_a;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -91);
  sf_debug_symbol_scope_pop();
  for (c2_i12 = 0; c2_i12 < 6; c2_i12++) {
    (*c2_b_pwm_out)[c2_i12] = c2_pwm_out[c2_i12];
  }

  for (c2_i13 = 0; c2_i13 < 3; c2_i13++) {
    (*c2_b_ctrl_stored_out)[c2_i13] = c2_ctrl_stored_out[c2_i13];
  }

  *c2_b_Timer_prev_out = c2_Timer_prev_out;
  *c2_b_counter_out = c2_counter_out;
  *c2_b_ctrl_sig = c2_ctrl_sig;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *)
    chartInstanceVoid;
   ...
   mxArray *c2_ctrl_sig, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_ctrl_sig),
    &c2_thisId);
  ...
  *c2_inData)
{
  ...
  for (c2_i18 = 0; c2_i18 < 6; c2_i18++) {
    c2_b_inData[c2_i18] = (*(real_T (*)[6])c2_inData)[c2_i18];
  }
   ...
   mxArray *c2_pwm_out, const char_T *c2_identifier, real_T c2_y[6])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_pwm_out), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_pwm_out);
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *)
    chartInstanceVoid;
  c2_pwm_out = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_pwm_out), &c2_thisId, c2_y);
  ...
  for (c2_i21 = 0; c2_i21 < 6; c2_i21++) {
    (*(real_T (*)[6])c2_outData)[c2_i21] = c2_y[c2_i21];
  }
...
const mxArray
  *sf_c2_sim_Motor_2kW_closedloop_v7_delay_get_eml_resolved_functions_info(void)
{
  ...
  for (c2_i22 = 0; c2_i22 < 8; c2_i22++) {
    ...
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", c2_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c2_r0->name)), "name", "nameCaptureInfo", c2_i22);
    ...
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTimeLo,
      7, 0U, 0U, 0U, 0), "fileTimeLo", "nameCaptureInfo", c2_i22);
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTimeHi,
      7, 0U, 0U, 0U, 0), "fileTimeHi", "nameCaptureInfo", c2_i22);
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->mFileTimeLo,
      7, 0U, 0U, 0U, 0), "mFileTimeLo", "nameCaptureInfo", c2_i22);
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->mFileTimeHi,
      7, 0U, 0U, 0U, 0), "mFileTimeHi", "nameCaptureInfo", c2_i22);
  }
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_closedloop_v7_delay), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_closedloop_v7_delay);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_closedloop_v7_delay_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3307987702U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(39355611U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2501744445U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2621048281U);
}

mxArray *sf_c2_sim_Motor_2kW_closedloop_v7_delay_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vpsnE8S3pii9sylBfOpA2F");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v7_delay
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[19],T\"Timer_prev_out\",},{M[1],M[25],T\"counter_out\",},{M[1],M[34],T\"ctrl_sig\",},{M[1],M[23],T\"ctrl_stored_out\",},{M[1],M[5],T\"pwm_out\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_closedloop_v7_delay\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_closedloop_v7_delay_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"pwm_out");
          ...
          _SFD_SET_DATA_PROPS(12,2,0,1,"ctrl_sig");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,6925);
        _SFD_CV_INIT_EML_IF(0,1,0,4536,4562,4793,4919);
        _SFD_CV_INIT_EML_IF(0,1,1,4928,4958,5106,5408);
        _SFD_CV_INIT_EML_IF(0,1,2,5106,5146,5323,5408);
        _SFD_CV_INIT_EML_IF(0,1,3,5424,5454,5554,5703);
        _SFD_CV_INIT_EML_IF(0,1,4,5554,5594,5645,5703);
        _SFD_CV_INIT_EML_IF(0,1,5,5719,5751,5847,5996);
        _SFD_CV_INIT_EML_IF(0,1,6,5847,5887,5938,5996);
        _SFD_CV_INIT_EML_IF(0,1,7,5998,6023,-1,6375);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_pwm_out);
          ...
          _SFD_SET_DATA_VALUE_PTR(12U, c2_ctrl_sig);
        }
      }
    } else {
...
{
  return "CTZmHRIL4z23MptEcmFrL";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v7_delay(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v7_delay(void
  *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v7_delay(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v7_delay(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v7_delay();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v7_delay(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_closedloop_v7_delay
      ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_sim_Motor_2kW_closedloop_v7_delay_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_sim_Motor_2kW_closedloop_v7_delay
    ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_closedloop_v7_delay
      ((SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_sim_Motor_2kW_closedloop_v7_delay_optimization_info();
  ...
  ssSetChecksum0(S,(729632448U));
  ssSetChecksum1(S,(2340624523U));
  ssSetChecksum2(S,(3476166896U));
  ssSetChecksum3(S,(775821032U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_closedloop_v7_delay(SimStruct *S)
{
  SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct *)malloc
    (sizeof(SFc2_sim_Motor_2kW_closedloop_v7_delayInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_sim_Motor_2kW_closedloop_v7_delay;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v7_delay;
...
void c2_sim_Motor_2kW_closedloop_v7_delay_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_closedloop_v7_delay(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_closedloop_v7_delay(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_closedloop_v7_delay(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_closedloop_v7_delay_method_dispatcher.\n"
