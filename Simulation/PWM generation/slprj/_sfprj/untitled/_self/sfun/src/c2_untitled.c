...
const mxArray *sf_c2_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[0].fileTimeLo = 1286786350U;
  ...
  (*c2_b_info)[1].fileTimeLo = 1286786336U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1549413848U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3255489850U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(985339254U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2980866440U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wq8maGgv4ARZAvxoBRccqD");
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(342528763U));
  ssSetChecksum1(S,(3233755489U));
  ssSetChecksum2(S,(2543301797U));
  ssSetChecksum3(S,(1752115344U));
