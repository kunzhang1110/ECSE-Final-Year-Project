  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2308466347U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1665768372U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(11850763U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(11523197U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "wq8maGgv4ARZAvxoBRccqD") == 0) {
