...
static const char * c2_debug_family_names[25] = { "REF_AMP", "REF_FREQ",
  ...
  "pwm_1", "pwm_2", "pwm_3", "pwm_4", "pwm_5", "pwm_6", "mag_fb", "nargin",
  "nargout", "phase_a", "phase_b", "t", "fb_phase_a", "fb_phase_b", "ctrl_sig",
  "error" };

/* Function Declarations */
static void initialize_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void initialize_params_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void enable_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void disable_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void sf_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void c2_chartstep_c2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void initSimStructsc2_sim_Motor_2kW_openloop_THD
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *
  chartInstance, const mxArray *c2_ctrl_sig, const char_T *c2_identifier, real_T
  c2_y[6]);
static void c2_d_emlrt_marshallIn(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[18]);
static void c2_eml_scalar_eg(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct
  *chartInstance);
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_sim_Motor_2kW_openloop_THD, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *
  chartInstance);
  ...
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_THD = 0U;
}
  ...
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_THD;
   ...
   *c2_st)
{
  ...
  *c2_error = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "error");
  chartInstance->c2_is_active_c2_sim_Motor_2kW_openloop_THD =
    c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "is_active_c2_sim_Motor_2kW_openloop_THD");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sim_Motor_2kW_openloop_THD(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_Motor_2kW_openloop_THD(chartInstance);
  ...
  (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_1, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_2, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_3, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_4, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_pwm_5, 13U, c2_sf_marshallOut,
    c2_sf_marshallIn);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_sim_Motor_2kW_openloop_THD_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_sim_Motor_2kW_openloop_THD, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_Motor_2kW_openloop_THD), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_Motor_2kW_openloop_THD);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_sim_Motor_2kW_openloop_THD_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4277884400U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3572726152U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2408550106U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3244950187U);
}

mxArray *sf_c2_sim_Motor_2kW_openloop_THD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("KQh63X4edNqjYLpeOIE9AD");
...
static const mxArray *sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_THD(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"ctrl_sig\",},{M[1],M[11],T\"error\",},{M[8],M[0],T\"is_active_c2_sim_Motor_2kW_openloop_THD\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_Motor_2kW_openloop_THD_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2895);
        _SFD_CV_INIT_EML_IF(0,1,0,2159,2184,2251,2337);
        _SFD_CV_INIT_EML_IF(0,1,1,2339,2364,2422,2508);
        _SFD_CV_INIT_EML_IF(0,1,2,2510,2535,2593,2679);
...
{
  return "8vn2ubLZ4t8wmVvWV0fMvG";
}

static void sf_opaque_initialize_c2_sim_Motor_2kW_openloop_THD(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
  initialize_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_Motor_2kW_openloop_THD(void
  *chartInstanceVar)
{
  enable_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_Motor_2kW_openloop_THD(void
  *chartInstanceVar)
{
  disable_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_Motor_2kW_openloop_THD(void
  *chartInstanceVar)
{
  sf_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_sim_Motor_2kW_openloop_THD
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_THD();/* state var info */
...
extern void sf_internal_set_sim_state_c2_sim_Motor_2kW_openloop_THD(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_sim_Motor_2kW_openloop_THD
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_sim_Motor_2kW_openloop_THD(S);
}

static void sf_opaque_set_sim_state_c2_sim_Motor_2kW_openloop_THD(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_sim_Motor_2kW_openloop_THD(S, st);
}

static void sf_opaque_terminate_c2_sim_Motor_2kW_openloop_THD(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_sim_Motor_2kW_openloop_THD
      ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_sim_Motor_2kW_openloop_THD
    ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_Motor_2kW_openloop_THD(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_sim_Motor_2kW_openloop_THD
      ((SFc2_sim_Motor_2kW_openloop_THDInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_THD(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(491396143U));
  ssSetChecksum1(S,(2114467800U));
  ssSetChecksum2(S,(2377293141U));
  ssSetChecksum3(S,(2610394201U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_sim_Motor_2kW_openloop_THD(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_Motor_2kW_openloop_THD(SimStruct *S)
{
  SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct *)malloc(sizeof
    (SFc2_sim_Motor_2kW_openloop_THDInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_sim_Motor_2kW_openloop_THDInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_sim_Motor_2kW_openloop_THD;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_THD;
...
void c2_sim_Motor_2kW_openloop_THD_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_Motor_2kW_openloop_THD(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_Motor_2kW_openloop_THD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_Motor_2kW_openloop_THD(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_Motor_2kW_openloop_THD_method_dispatcher.\n"
